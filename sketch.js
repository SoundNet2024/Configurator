...
function draw() {
  ...
  if (TransparenciaBLE < 50) {
    ...
    inputMenssaje.value(' Máximo 600 caracteres');
      
    } else if (languaje == "EN") {

    inputMenssaje.value(' Maximum 600 characters');
  ...
  tint(r, g, b);
      ...
      if (mouseIsPressed == true) {
        ...
        tint(219, 255, 176);
          ...
          if (languaje == "ES") {
            ...
            image(AceptarEN, width/2 - AceptarEN.width*windowHeight*0.00055/2, windowHeight*0.2 + windowHeight*4.55, AceptarEN.width*width*0.00055, AceptarEN.height*windowHeight*0.00055);
    ...
    let volumenaltura = map(volumen, 0, 999, windowHeight*0.1, windowHeight*0.62);
    ...
    inputMenssaje.attribute('maxlength', '600');
    ...
    if (inputMenssaje.value() === ' Máximo 600 caracteres') {
    
      inputMenssaje.style('color', 'rgb(200, 130, 10)'); // Cambia el color del texto a rojo
      
  } else if (inputMenssaje.value() === ' Maximum 600 characters') {
  ...
  if (inputCorreo6.value() === ' Email 6') {
    ...
    if (inputMenssaje.value() === ' Maximum 600 characters' || inputMenssaje.value() === ' Máximo 600 caracteres') {
